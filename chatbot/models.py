...
class EstadoConversacion(str, Enum):
    ...
    PRESUPUESTO_MENU = "presupuesto_menu"
    PRESUPUESTO_EXTINTOR_TIPO = "presupuesto_extintor_tipo"
    PRESUPUESTO_EXTINTOR_CONFIRMAR_CONTACTO = "presupuesto_extintor_confirmar_contacto"
    PRESUPUESTO_EXTINTOR_SERVICIO = "presupuesto_extintor_servicio"
    PRESUPUESTO_EXTINTOR_CANTIDAD = "presupuesto_extintor_cantidad"
    PRESUPUESTO_EXTINTOR_CANTIDAD_MANUAL = "presupuesto_extintor_cantidad_manual"
    PRESUPUESTO_AGREGAR_OTRO = "presupuesto_agregar_otro"
    PRESUPUESTO_CORRIGIENDO_SECCION = "presupuesto_corrigiendo_seccion"
    PRESUPUESTO_CORRIGIENDO_CONTACTO = "presupuesto_corrigiendo_contacto"
    PRESUPUESTO_PRODUCTOS_CORRIGIENDO = "presupuesto_productos_corrigiendo"
    PRESUPUESTO_PRODUCTOS_BORRAR = "presupuesto_productos_borrar"
    IFCI_NIVEL = "ifci_nivel"
    IFCI_HIDRANTES = "ifci_hidrantes"
    IFCI_ESTABLECIMIENTO = "ifci_establecimiento"
    IFCI_DETECTORES = "ifci_detectores"
    IFCI_PLANO = "ifci_plano"
    IFCI_CORRIGIENDO = "ifci_corrigiendo"
    IFCI_CORRIGIENDO_CAMPO = "ifci_corrigiendo_campo"
...
class ConversacionData(BaseModel):
    ...
    handoff_case_id: Optional[str] = None  # Case id persistido del inbox humano
